...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String[] data = FilesService.read(STUDENTS_LIST_URL);
        Student[] students = StudentService.createStudents(data);
        ...
        Student[] sort = StudentService.sortStudentsbyYear(students);
        for (Student s : sort) {
