...
import Airoport.service.AiroportService;
...
public class AiroportTest {
    public static void main(String[] args) {
        ...
        boolean start = true;
        AiroportService service = new AiroportService();
        ...
        while (start) {
            ...
            switch (num) {
                ...
                case 8: {
                    ...
                    service.printInfo(service.getMinWeightPlane(planes));
                    System.out.println("***************< End task >***************");
                    break;
                }
                case 9: {
                    System.out.println("*************** Task 9 ***************");
                    service.printInfo(service.getMinCostMilitaryPlane(planes));
                    System.out.println("***************< End task >***************");
                    break;
                }
                case 10: {
